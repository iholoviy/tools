...
Foreach ($VM in $newVMs) {
    ...
    $RP=Get-Cluster QA-Cluster | Get-ResourcePool QA-Team |Select-Object -First 1
    $taskTab[(New-VM -Name $VM.Name -ResourcePool $RP -Location $VM.Folder -Datastore $VM.Datastore -DiskStorageFormat $VM.DiskStorageFormat `
